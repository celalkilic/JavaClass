...
public class StringMethods {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		 * indexOf(char character),indexOf(char character, int beginIndex) String
		 * string7 = "Postman API"; System.out.println(string7.indexOf('P'));
		...
		//Split methot
		String string3 = "celal-kilicarslan-manchester";
