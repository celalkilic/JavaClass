...
public class J_4_ElseIfExamples {
	...
	public static void main(String[] args) {
		...
		/*
		 * boolean myBoolean = true; if (!myBoolean) { System.out.println("If Block"); }
		 * 
		 * else if (true) { System.out.println("Else If Block"); }else if (false) {
		 * System.out.println("Second Else if Block"); }else {
